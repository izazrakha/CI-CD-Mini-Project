...
public class Product {
    ...
    public void response4(){restAssuredThat(response -> response.statusCode(200));}
...
//        restAssuredThat(response -> response.statusCode(200));
    ...
    @Step("I failed create a comment in product with status code 401")
    ...
    @Step("I failed create a comment in product with response code 401")
