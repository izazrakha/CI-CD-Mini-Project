...
public class Register {
    ...
    public void getHTTPrequest4(){
        JSONObject body = new JSONObject();
        body.put("ema","izazrakha@gmail.com");
        body.put("passwo","ijas123");
        body.put("fulln","Ijazz");
    ...
    public void getHTTPrequest6(){
        ...
        body.put("password","ijas123");
        body.put("fullname","ijas ijas");
