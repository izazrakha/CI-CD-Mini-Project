Feature: Login
  Scenario: AP007 - Successfully login by entering valid email and password
  ...
  Scenario: AP008 - Fail to login because email and password field is empty
  ...
  Scenario: AP009 - Fail to login because email field is empty
  ...
  Scenario: AP010 - Fail to login because password field is empty
  ...
  Scenario: AP011 - Fail to login because email invalid
  ...
  Scenario: AP012 - Fail to login because filling email field with username
  ...
  Scenario: AP013 - Failed to login because body parameter is invalid
  ...
  Scenario: AP014 - Failed to login because body is empty
  ...
  Scenario: AP015 - Failed to login because method is wrong
